                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(item.nombre, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                              ...
                              SizedBox(width: 72, child: Text(formatMoney(item.total), textAlign: TextAlign.right, style: const TextStyle(color: AppColors.orange, fontWeight: FontWeight.bold))),
...
class _QtyStepper extends StatelessWidget {
  ...
  Widget _stepBtn(IconData icon, VoidCallback onTap) {
    return InkWell(
      ...
      child: Container(padding: const EdgeInsets.all(4), decoration: BoxDecoration(color: AppColors.background, borderRadius: BorderRadius.circular(6)), child: Icon(icon, size: 14, color: AppColors.orange)),
    );
  }
}
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: TextStyle(color: bold ? AppColors.orange : Colors.white, fontSize: bold ? 18 : 13, fontWeight: bold ? FontWeight.bold : FontWeight.w600)),
        ],
      ),
    );
  }
