        ...
        Padding(
          ...
          child: TextField(
            decoration: InputDecoration(
              hintText: 'Buscar fruta o verdura...',
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, i) {
              ...
              return ChoiceChip(
                ...
                labelStyle: TextStyle(color: activa ? AppColors.orange : Colors.white70, fontWeight: activa ? FontWeight.bold : FontWeight.normal),
                side: BorderSide(color: activa ? AppColors.orange : Colors.transparent),
              );
            },
          ),
        ),
  ...
  Widget _buildGrid(List<Producto> productos, double tasa) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return _ProductoCard(producto: p, tasa: tasa, disabled: sinStock, onTap: sinStock ? null : () => context.read<CartController>().agregarProducto(p));
      },
    );
  }
}
...
class _ProductoCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = disabled ? Colors.white24 : AppColors.orange;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(formatBs(producto.precio, tasa), style: const TextStyle(color: AppColors.green, fontWeight: FontWeight.bold, fontSize: 11)),
              Text(disabled ? 'Sin stock' : '${producto.stock.toStringAsFixed(producto.stock.truncateToDouble() == producto.stock ? 0 : 1)} ${producto.unidad}', style: const TextStyle(color: Colors.white38, fontSize: 10)),
            ],
          ),
        ),
      ),
