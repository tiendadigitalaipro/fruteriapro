        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.local_grocery_store, color: AppColors.orange, size: 56),
                const SizedBox(height: 12),
                const Text('Frutería Pro', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                ...
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        TextField(controller: _keyCtrl, style: const TextStyle(color: Colors.white), textCapitalization: TextCapitalization.characters, decoration: const InputDecoration(labelText: 'Código de licencia', hintText: 'PRO-FRUTERIA-XXXXXXXX')),
                        ...
                        FilledButton(
                          style: FilledButton.styleFrom(backgroundColor: AppColors.orange, foregroundColor: Colors.black, padding: const EdgeInsets.symmetric(vertical: 14)),
                          onPressed: _activando ? null : _activar,
                          child: _activando ? const SizedBox(height: 18, width: 18, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.black)) : const Text('Activar licencia'),
                        ),
                      ],
                    ),
                  ),
                ...
                const SizedBox(height: 8),
                OutlinedButton.icon(onPressed: _copiarNumero, icon: const Icon(Icons.chat, size: 18), label: Text('Escríbenos al $_whatsappVentas'), style: OutlinedButton.styleFrom(foregroundColor: AppColors.orange, side: const BorderSide(color: AppColors.orange))),
