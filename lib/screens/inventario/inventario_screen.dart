  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            ...
            icon: Icon(_modoEtiquetas ? Icons.close : Icons.label, color: AppColors.orange),
            label: Text(_modoEtiquetas ? 'Cancelar' : 'Etiquetas', style: const TextStyle(color: AppColors.orange)),
          ),
        ],
      ),
      floatingActionButton: _modoEtiquetas
          ...
          : FloatingActionButton(heroTag: 'inv_fab', backgroundColor: AppColors.orange, foregroundColor: Colors.black, onPressed: () => _abrirFormulario(context), child: const Icon(Icons.add)),
              ...
              itemBuilder: (context, i) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    leading: CircleAvatar(backgroundColor: AppColors.orange.withValues(alpha: 0.15), child: Text(p.emoji, style: const TextStyle(fontSize: 16))),
                    ...
                    trailing: Row(
                      ...
                      children: [
                        Text(formatMoney(p.precio), style: const TextStyle(color: AppColors.orange, fontWeight: FontWeight.bold)),
