      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Card(
              child: ListTile(
                leading: Icon(licencia.estado == EstadoLicencia.activa ? Icons.verified : Icons.timer_outlined, color: licencia.estado == EstadoLicencia.activa ? Colors.greenAccent : AppColors.orange),
