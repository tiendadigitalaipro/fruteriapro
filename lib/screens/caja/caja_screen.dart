    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: TextStyle(color: destacado ? AppColors.orange : Colors.white, fontWeight: destacado ? FontWeight.bold : FontWeight.normal, fontSize: destacado ? 15 : 13)),
        ],
      ),
    );
  }
