...
const _slides = [
  ...
  _Slide(
    icon: Icons.balance,
    titulo: 'Controla la merma',
    texto: 'Registra lo que se daña o se pierde — sabes cuánto te cuesta realmente cada fruta.',
  ),
  _Slide(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(colors: [AppColors.orange, AppColors.orangeDim], begin: Alignment.topLeft, end: Alignment.bottomRight),
                            borderRadius: BorderRadius.circular(28),
                            boxShadow: [BoxShadow(color: AppColors.orange.withValues(alpha: 0.35), blurRadius: 28, offset: const Offset(0, 12))],
                          ),
            ...
            Row(
              ...
              children: List.generate(_slides.length, (i) {
                ...
                return AnimatedContainer(
                  ...
                  width: activo ? 22 : 8,
                  height: 8,
                  decoration: BoxDecoration(color: activo ? AppColors.green : Colors.white24, borderRadius: BorderRadius.circular(4)),
                );
              }),
            ),
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: AppColors.orange, foregroundColor: Colors.white, minimumSize: const Size.fromHeight(52), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
