...
/// de fruteria-pro.html.
class CartController extends ChangeNotifier {
  final List<CartItem> items = [];
  double descuentoUsd = 0;
  double tasaCambio = 40;
  int? empleadoActivoId;
  String empleadoActivoNombre = 'Sistema';
  ...
  void setEmpleadoActivo(int? id, String nombre) {
    empleadoActivoId = id;
    empleadoActivoNombre = nombre;
    notifyListeners();
  }
  ...
  Future<Venta> confirmarVenta({
    ...
    final venta = Venta(
      ...
      empleadoNombre: empleadoActivoNombre,
    );
